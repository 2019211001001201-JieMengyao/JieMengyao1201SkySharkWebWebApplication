<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RequestID.aspx.cs" Inherits="JieMengyao1201SkySharkWebWebApplication.BM.RequestID" %>
      ...
      <form id="form1" runat="server">
          ...
          <div class="tabContents">
            <table>
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Request User New ID"></asp:Label>
                    </td>
                    <td></td>  
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserID" ErrorMessage="Please specify a vaild user name"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:ListBox ID="lstRole" runat="server" Width="138px">
